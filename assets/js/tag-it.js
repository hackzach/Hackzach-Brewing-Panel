            ...
            if (!addedExistingFromSingleFieldNode) {
                this.tagList.children('li').each(function() {
                    if (!$(this).hasClass('tagit-new')) {
                        that.createTag($(this).text(), $(this).attr('id'), $(this).attr('class'), true);
                        $(this).remove();
                    }
                });
            }
        ...
        createTag: function(labelname, value, additionalClass, duringInitialization) {
 	    ...
 	    labelname	= $.trim(labelname);
            ...
            if (!this.options.singleField) {
                ...
                tag.append('<input type="hidden" value="' + escapedValue + '" name="' + this.options.itemName + '[' + this.options.fieldName + '][]" class="tagit-hidden-field" />');
            }
